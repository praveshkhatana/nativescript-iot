...
declare function AWSDDExtractFileNameWithoutExtension(filePath: string, copy: boolean): string;
...
declare class AWSFMDatabase extends NSObject {
	...
	executeQueryWithArgumentsInArray(sql: string, _arguments: NSArray<any>): AWSFMResultSet;
...
declare class AWSJSONDictionary extends NSDictionary<NSObject, NSObject> {
	...
	static dictionaryWithObjectsForKeys(objects: NSArray<ObjectType>, keys: NSArray<KeyType>): AWSJSONDictionary; // inherited from NSDictionary
...
declare class AWSMTLJSONAdapter extends NSObject {
	...
	static JSONArrayFromModels(models: NSArray<any>): NSArray<any>;
	...
	static modelsOfClassFromJSONArrayError(modelClass: typeof NSObject, JSONArray: NSArray<any>): NSArray<any>;
...
declare function AWSMTLSelectorWithCapitalizedKeyPattern(prefix: string, key: string, suffix: string): string;

declare function AWSMTLSelectorWithKeyPattern(key: string, suffix: string): string;
...
declare class AWSModelUtility extends NSObject {
	...
	static JSONArrayFromMapMTLArray(mapMTLArray: NSArray<any>): NSArray<any>;
	...
	static mapMTLArrayFromJSONArrayWithModelClass(JSONArray: NSArray<any>, modelClass: typeof NSObject): NSArray<any>;
...
declare class AWSTask<ResultType> extends NSObject {
	...
	static taskForCompletionOfAllTasks<ResultType>(tasks: NSArray<AWSTask<any>>): AWSTask<ResultType>;

	static taskForCompletionOfAllTasksWithResults<ResultType>(tasks: NSArray<AWSTask<any>>): AWSTask<ResultType>;

	static taskForCompletionOfAnyTask<ResultType>(tasks: NSArray<AWSTask<any>>): AWSTask<ResultType>;
